...
def load_disease_network(disease_sim_file="../Data/DODisSimNet.txt"):
...
# Main function
def main(embedding_size=128, epochs=50, disease_sim_file="../Data/DODisSimNet.txt"):
...
if __name__ == "__main__":
    disease_sim_file = "../Data/DODisSimNet.txt"
